...
def generate(m, n, condition):
    ...
    if condition == 'fixed':
        ...
        t_matrix = np.array([[0, 3, 3, 3, 4, 4, 4, 1, 1, 0],
                             [3, 0, 0, 0, 1, 1, 1, 2, 2, 3],
                             [3, 0, 0, 0, 1, 1, 1, 2, 2, 3],
                             [3, 0, 0, 0, 1, 1, 1, 2, 2, 3],
                             [4, 1, 1, 1, 0, 0, 0, 3, 3, 3],
        ...
        slots = 8
        membership = [0,1,1,1,2,2,2,3,3,4]

    if condition == 'SB':
        f = [[2], [4, 5], [7], [9, 10]]
        monitoring = [1, 0.03, 0.01, 0.02, 0.05, 0.002]
        families = []
        for fam in f:
            families.append(fam + [fam[-1] + 1])
        list1 = [[1]]
