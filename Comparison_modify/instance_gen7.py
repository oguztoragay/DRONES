...
arcs = {'DP': [34.02889809043227, -117.83417609430023, 34.02889809043227, -117.83417609430023, 0],
        ...
        'TT_iDL': [34.082150272643005, -117.56158799481022, 34.082150272643005, -117.56158799481022, 0],
...
# def hexa_data(t_matrix, due_date, due_date2, monitor_times, slots, charges, ndrones, families, i_times):
...
#     he_data_= [n_drone_modi, slots, expan, t_expanded, depos, real_nodes, idles, charges_expanded, due_date_expanded, due_date2_expanded, monitor_times_expanded, families_expanded, i_times]
#     return he_data_
