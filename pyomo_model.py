...
m.x = Var(n_demandnode, n_slot, n_drones, domain=Binary)
...
m.y = Var(n_demandnode, n_demandnode, n_slot, n_drones, domain=Binary)
...
m.c = Var(n_slot, n_drones, domain=Integers)
# C = LpVariable.matrix("C", Cri_names, cat="Integer")
# allocation3 = np.array(C).reshape(v)
...
m.v = Var(n_demandnode, n_slot, n_drones, domain=Integers)
